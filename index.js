...
/* BLOCK STARTS /Source: /Users/fatihacet/Applications/CodeMirror.kdapp/lib/codemirror/mode/javascript/javascript.js */
...
CodeMirrorBottomBar = (function(_super) {
  ...
  function CodeMirrorBottomBar(options, data) {
    ...
    CodeMirrorBottomBar.__super__.constructor.call(this, options, data);
    this.caretPos = new KDView({
  ...
  CodeMirrorBottomBar.prototype.updateCaretPos = function(posObj) {
    return this.caretPos.updatePartial("" + (posObj.line + 1) + ":" + (posObj.ch + 1));
  };
...
CodeMirrorTopBar = (function(_super) {
  ...
  function CodeMirrorTopBar(options, data) {
    ...
    CodeMirrorTopBar.__super__.constructor.call(this, options, data);
  }

  return CodeMirrorTopBar;
